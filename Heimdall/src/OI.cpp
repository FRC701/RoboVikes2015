...
OI::OI() {
	...
	cYellow = new JoystickButton(coDriver, 1);
	cSmallred = new JoystickButton(coDriver, 1);
	cSmallblack = new JoystickButton(coDriver, 1);
	cGreen = new JoystickButton(coDriver, 1);

	cBlue = new JoystickButton(coDriver, 1);
	cWhite = new JoystickButton(coDriver, 1);
	cBlack = new JoystickButton(coDriver, 1);
	cRed = new JoystickButton(coDriver, 1);
