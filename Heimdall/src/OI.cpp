...
OI::OI() {
	...
	dButtonLT = new JoystickButton(driver, 8);
	dButtonLT->WhileHeld(new slideCounterClockRotation());
	dButtonRT = new JoystickButton(driver, 7);
	dButtonRT->WhileHeld(new slideClockRotation());
