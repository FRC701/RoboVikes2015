...
#include "Commands/AutoLeftForwardDrive.h"
#include "Commands/AutoLeftForwardDriveTest.h"
#include "Commands/AutoPneumaticIntakeIn.h"
#include "Commands/AutoRightForwardDrive.h"
#include "Commands/AutoRightForwardDriveTest.h"
...
OI::OI() {
	...
	SmartDashboard::PutData("AutoLeftForwardDrive", new AutoLeftForwardDrive());

	SmartDashboard::PutData("AutoLeftForwardDriveTest", new AutoLeftForwardDriveTest());

	SmartDashboard::PutData("AutoRightForwardDrive", new AutoRightForwardDrive());

	SmartDashboard::PutData("AutoRightForwardDriveTest", new AutoRightForwardDriveTest());
