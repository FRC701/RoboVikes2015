...
#include "AutoPneumaticIntakeOut.h"

AutoPneumaticIntakeOut::AutoPneumaticIntakeOut() {
...
void AutoPneumaticIntakeOut::Initialize() {
...
bool AutoPneumaticIntakeOut::IsFinished() {
	return true;
}
