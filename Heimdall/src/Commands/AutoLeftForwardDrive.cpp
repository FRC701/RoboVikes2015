...
#include "AutoLeftForwardDrive.h"

AutoLeftForwardDrive::AutoLeftForwardDrive()
:driveDistance(0.0)
,
goalDistance(0.0)
{
...
void AutoLeftForwardDrive::Initialize() {
	goalDistance=Robot::prefs->GetDouble("driveDistanceStrafeLeft",0.0);
}

// Called repeatedly when this Command is scheduled to run
void AutoLeftForwardDrive::Execute() {
	driveDistance=Robot::chassis->leftFront->GetEncPosition();
