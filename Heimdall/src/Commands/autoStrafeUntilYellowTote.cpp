...
void autoStrafeUntilYellowTote::Execute() {
	Robot::chassis->robotDrive->MecanumDrive_Cartesian(
			Robot::prefs->GetDouble("speedStrafeUntilYellowTote")0.0),0.0,0.0,0.0);
}

// Make this return true when this Command no longer needs to run execute()
bool autoStrafeUntilYellowTote::IsFinished() {
	return (Robot::chassis->rightLightSensor->Get() == true && Robot::chassis->leftLightSensor->Get() == true);
}
