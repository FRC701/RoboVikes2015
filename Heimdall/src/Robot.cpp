...
#include "Commands/autoThreeToteL.h"
...
CanGrabbers* Robot::canGrabbers = 0;
OI* Robot::oi = 0;
...
//Autos......................................................................................
	...
	autonomousModeChooser->AddObject("Auto Three Tote Auto",new autoThreeToteL());
...
//StartUp....................................................................................
	...
	canGrabbers->canGrabbersSolenoid->Set((DoubleSolenoid::kReverse));
...
void Robot::TeleopInit() {
	...
	if (!Robot::prefs->ContainsKey("intakeRightJoystickMultiplier"))
		Robot::prefs->PutDouble("intakeRightJoystickMultiplier", 0.75);
	if (!Robot::prefs->ContainsKey("autoDrive"))
		Robot::prefs->PutInt("autoDrive", 7300);
	if (!Robot::prefs->ContainsKey("autoDriveTimeout"))
		Robot::prefs->PutDouble("autoDriveTimeout", 4.5);
	if (!Robot::prefs->ContainsKey("autoDriveThreeTote"))
