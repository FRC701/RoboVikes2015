...
#include "Commands/autoStrafeUntilYellowTote.h"
...
void Robot::RobotInit() {
	...
	autonomousModeChooser->AddDefault("Autonomous 1", new haySqueezerToggle());
	autonomousModeChooser->AddObject("Autonomous 2", new pneIntakeToggle());
	autonomousModeChooser->AddObject("Autonomous 3", new autoStrafeUntilYellowTote());
