...
Spool::Spool() : Subsystem("Spool") {
	...
	breakSolenoid = RobotMap::spoolbreakSolenoid;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
	spoolLeftMotor = RobotMap::spoolLeftMotor;
	spoolRightMotor = RobotMap::spoolRightMotor;
	pidInput = new CANTalonEncoderPIDSource(spoolRightMotor); //kInverted TODO be added
	pidOutput = new Elevator(spoolLeftMotor, spoolRightMotor, breakSolenoid);
